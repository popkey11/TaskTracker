                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoTitle" value="<?php echo $FTPrjPoTitle; ?>"
                                    name="oetPoTitle" class="form-control" placeholder="title" maxlength="255">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                        ...
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoProgress" name="oetPoProgress" class="form-control"
                                    placeholder="Progress" maxlength="255" value="<?php echo $FTPrjPoProgress; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoNo" name="oetPoNo" class="form-control" placeholder="PO No"
                                    maxlength="255" value="<?php echo $FTPrjPoDocNo; ?>">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoRemark" name="oetPoRemark" class="form-control"
                                    placeholder="PO Remark" maxlength="255" value="<?php echo $FTPrjPoRemark; ?>">
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoDate" name="oetPoDate" class="form-control"
                                    placeholder="PO Date" maxlength="255" value="<?php echo $FDPrjPoDateDocDate; ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoPlanStart" name="oetPoPlanStart" class="form-control"
                                    placeholder="Plan Start" maxlength="255" value="<?php echo $FDPrjPoPlanStart; ?>">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoFinish" name="oetPoFinish" class="form-control"
                                    placeholder="Plan Finish" maxlength="255" value="<?php echo $FDPrjPoPlanFinish; ?>">
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-group col-md-12 input-data">
                                ...
                                <input type="text" id="oetPoUrlRefer" name="oetPoUrlRefer" class="form-control"
                                    placeholder="Url Refer Plan" maxlength="255" value="<?php echo $FTPrjPoRefUrl; ?>">
                            </div>
                        </div>
                    </div>
